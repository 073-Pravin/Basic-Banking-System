            ...
            <div class="container-fluid">
                ...
                <div class="row activity text-center activity-style">
                    <div class="col-md act act-style">
                        ...
                        <br>
                        <a href="createuser.php"><button class="ind_btn">Create a User</button></a>
                    </div>
                    <div class="col-md act act-style">
                        <img src="img/transfer.svg" class="my-img-fluid">
                        <br>
                        <a href="transfermoney.php"><button class="ind_btn">Make a Transaction</button></a>
                    </div>
                    <div class="col-md act act-style act-style-history">
                        <img src="img/history.svg" class="my-img-fluid">
                        <br>
                        <a href="transactionhistory.php"><button class="ind_btn">Transaction History</button></a>
                    </div>
                </div>
            </div>
